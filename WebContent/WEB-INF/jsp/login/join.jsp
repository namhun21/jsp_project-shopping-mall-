...
<body>
	<script>
		function checkValue(){
			var form = eval("document.userInfo");
			...
			if(!form.userphnumber.value){
				alert("전화번호를 입력해주세요");
				form.userphnumber.focus();
				return false;
			}
		}
	</script>
  <form action="joinok" method="post" class="checkout-form" name = "userInfo" onsubmit = "return checkValue()">
	<div id="header">
		<h1>회원가입</h1>
	</div>
	<div id="wrapper">
		<div id="content">
			...
			<div>
				...
				<span class="box int_pass"> <input type="password" id="userpw" name="userpw"
					class="int" maxlength="20" placeholder="비밀번호 입력" required>
			...
			<div>
				...
				<span class="box int_name"> <input type="text" id="name" name="username"
					class="int" maxlength="20" placeholder="이름 입력" required>
				</span> <span class="error_next_box"></span>
			</div>
			<div>
				<h3 class="join_title">
				...
				<span class="box int_email"> <input type="text" id="useraddress" name="useraddress"
					class="int" maxlength="500" placeholder="주소 입력" required>
				</span>
			</div>
			...
			<div>
				...
				<span class="box int_email"> <input type="text" id="useremail" name="useremail"
					class="int" maxlength="50" placeholder="이메일 입력" required>
				</span>
			</div>
			...
			<div>
				...
				<span class="box int_mobile"> <input type="tel" id="userphnumber" name="userphnumber"
					class="int" maxlength="20" placeholder="전화번호 입력" required>
				</span> <span class="error_next_box"></span>
			</div>
